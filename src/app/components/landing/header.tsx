...
export function Header() {
  ...
  const navigation = [
    ...
    { name: 'Use Cases', href: 'https://global.chains-erp.com/use-cases' },
    { name: 'Pricing', href: 'https://global.chains-erp.com/pricing' }
  ]
  ...
  const products = [
    {
      ...
      icon: Building,
      href: 'https://global.chains-erp.com/auth'
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            >
              <Link
                href="https://global.chains-erp.com"
            ...
            >
              <div className="py-4 space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200 space-y-3">
                  ...
                  <Link
                    href="htt[s://global.chains-erp.com"
